...
def summarize_dataset(csv_path):
    """
    Įkelia CSV failą ir grąžina dvi pandas DataFrame lenteles:
    1. Skaitinių (continuous) požymių santrauka.
    2. Kategorinių (categorical) požymių santrauka.
    """
...
cont, cat = summarize_dataset("train.csv")
print(cont.head())
print(cat.head())